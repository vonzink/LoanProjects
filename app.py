    ...
    def __init__(self):
        self.field_mappings = {
            'wages': {
                ...
                'description': 'Wages (Line 1)'
            },
            'interest': {
                'patterns': [
                    r'Interest.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)',
                    r'Line\s+2.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)',
                    r'2\s+Interest.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)'
                ],
            ...
            'dividends': {
                'patterns': [
                    ...
                    r'Line\s+3.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)',
                    r'3\s+Dividends.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)'
                ],
                'description': 'Dividends (Line 3)'
            },
            'business_income': {
                'patterns': [
                    r'Business\s+income.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)',
                    r'Line\s+3.*?(\d{1,3}(?:,\d{3})*(?:\.\d{2})?)',
